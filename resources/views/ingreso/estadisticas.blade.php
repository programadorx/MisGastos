			...
			switch(filtro) {
			    case 'diario':
			    	...
			    	var hasta=$("#hasta").val();
			      	...
			      	if (desde !='' && hasta !=''){
 						...
 						$.ajax({
							url: '/ingreso/estadisticas/diario/'+desde+'/'+hasta,
							type: 'GET',
							data: { 
								desde: $("#desde").val(),
								hasta: $("#hasta").val()},
			    ...
			    case 'anual':
			    	...
			    	if (anio !=null) {
						...
						$.ajax({
							url: '/ingreso/estadisticas/poranio/'+anio,
							type: 'GET',
							data: {anio: $("#año").val()},
							dataType: 'JSON',
							beforeSend: function() {
			    ...
			    case 'mensual':
			    	...
			    	if (mes !=null){
			    		...
			    		$.ajax({
							url: '/ingreso/estadisticas/pormes/'+mes,
							type: 'GET',
							data: {mes: $("#mes").val()},
							dataType: 'JSON',
							beforeSend: function() {
			    ...
			    case 'mensuales':
			    	...
			    	if (aniodesde !=null && aniohasta !=null && aniodesde<=aniohasta) {
			    		...
			    		$.ajax({
							url: '/ingreso/estadisticas/mensual/'+aniodesde+'/'+aniohasta,
							type: 'GET',
							data: {
								aniodesde: $("#año").val(),
		    	...
		    	case 'categoria':
			    	...
			    	if (categoria !=null) {
						...
						$.ajax({
							url: '/ingreso/estadisticas/porcategoria/'+categoria,
							type: 'GET',
			    ...
			    case 'producto':
			    	...
			    	if (clasificacion !=null && tipo!=null) {
						...
						$.ajax({
							url: '/ingreso/estadisticas/porproducto/'+clasificacion+'/'+tipo,
							type: 'GET',
